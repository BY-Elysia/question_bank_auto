...
function detectQuestionEmptyAnswerIssue(item: QuestionItem) {
...
function buildSharedQuestionContentRuleLines(startNo: number, resultFieldName = 'questionsToUpsert') {
  return numberInstructionLines(startNo, [
